...
See `.agents/skills/tdd/tests.md` for examples and `.agents/skills/tdd/mocking.md` for mocking guidelines.

## Anti-Pattern: Horizontal Slices

**DO NOT write all tests first, then all implementation.** This produces tests that test the _shape_ of things rather than user-facing behavior.
...
- [ ] Identify opportunities for deep modules (`.agents/skills/tdd/deep-modules.md`)
