...
// The one-shot migration of the legacy date-keyed keys lives in migration.js.
...
export const DOW_OFFSETS = { Monday: 0, Tuesday: 1, Wednesday: 2, Thursday: 3, Friday: 4, Saturday: 5, Sunday: 6 };
...
export function currentPhase() {
  ...
  const profile = readJson('bh_athlete_profile', 'null');
