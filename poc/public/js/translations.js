const STRINGS = {
  en: {
    ...
    infoFamilyFormLoad:  'Form & Load',
    infoFamilyBodyMind:  'Body & Mind',
    infoFamilyVolume:    'Volume',
    infoFamilyPeaks:     'Peaks & Zones',
    infoPanelFormToday:  'Form Today',
    infoPanelRace:       'Race Countdown',
    infoWeeksUntil:      'weeks until',
    infoPanelLoad:       'Load History',
    infoWeeklyTss:       'weekly TSS',
    infoPanelConsistency:'Consistency',
    infoConsistencyNote: '{done} of {all} sessions completed',
    infoPanelCheckin:    'Check-in Signals',
    infoEnergy:          'Energy',
    infoSleepQuality:    'Sleep quality',
    infoMood:            'Mood',
    infoMotivation:      'Motivation',
    infoPanelSleep:      'Sleep & Feeling',
    infoSleepHours:      'Sleep hours',
    infoFeeling:         'Feeling (1–5)',
    infoPanelSplitDur:   'Sport Split — Duration',
    infoPanelSplitDist:  'Sport Split — Distance',
    infoSwim:            'swim',
    infoBike:            'bike',
    infoRun:             'run',
    infoPanelHours:      'Weekly Hours',
    infoAvgPerWeek:      'average {avg} h/week',
    infoPanelLongest:    'Longest Workout',
    infoLongestNote:     'longest session per week, minutes',
    infoPanelWork:       'Weekly Work (kJ)',
    infoPanelZones:      'Time in Zones',
    infoPanelPeakPower:  'Peak Power (W)',
    infoPanelPeakHr:     'Peak Heart Rate (bpm)',
    infoReadingCount:    '{n} of {total} panels have a reading',
    ...
    infoCompareOpen:     '⇆ Compare sessions',
    infoCompareTitle:    'Compare sessions',
    infoCompareResultTitle: 'Session Comparison',
    infoCompareClose:    'Close',
    infoCompareBack:     '‹ Change selection',
    infoCompareGo:       'Compare ({n})',
    infoCompareHint:     'pick 2 or more — same-kind comparisons tell the progression story',
    infoCompareNote:     'How it felt, next to what was done.',
    infoAllSports:       'All sports',
    infoAllTypes:        'All types',
    infoColDate:         'Date',
    infoColSession:      'Session',
    infoColSport:        'Sport',
    infoColType:         'Type',
    ...
    infoAvgHr:           'Avg HR',
    infoRange_r4:        'Last 4 weeks',
    infoRange_r12:       'Last 12 weeks',
    infoRange_all:       'All history',
    infoAddToGraph:      'Add to comparison graph',
    infoEnlarge:         'Enlarge',
    infoGraphTitle:      'Comparison Graph',
    infoGraphClear:      'Clear',
    infoGraphRemove:     'Remove from comparison graph',
    infoGraphNote:       'each line is scaled to its own range — compare shapes over time, not values',
    ...
    feedbackBodyShort:  'Body',
    feedbackMindShort:  'Mind',
  ...
  da: {
    ...
    infoFamilyFormLoad:  'Form & Belastning',
    infoFamilyBodyMind:  'Krop & Hoved',
    infoFamilyVolume:    'Volumen',
    infoFamilyPeaks:     'Peaks & Zoner',
    infoPanelFormToday:  'Form i dag',
    infoPanelRace:       'Nedtælling til løb',
    infoWeeksUntil:      'uger til',
    infoPanelLoad:       'Belastningshistorik',
    infoWeeklyTss:       'ugentlig TSS',
    infoPanelConsistency:'Kontinuitet',
    infoConsistencyNote: '{done} af {all} sessioner gennemført',
    infoPanelCheckin:    'Check-in-signaler',
    infoEnergy:          'Energi',
    infoSleepQuality:    'Søvnkvalitet',
    infoMood:            'Humør',
    infoMotivation:      'Motivation',
    infoPanelSleep:      'Søvn & Følelse',
    infoSleepHours:      'Timers søvn',
    infoFeeling:         'Følelse (1–5)',
    infoPanelSplitDur:   'Sportsfordeling — Varighed',
    infoPanelSplitDist:  'Sportsfordeling — Distance',
    infoSwim:            'svøm',
    infoBike:            'cykel',
    infoRun:             'løb',
    infoPanelHours:      'Ugentlige timer',
    infoAvgPerWeek:      'gennemsnit {avg} t/uge',
    infoPanelLongest:    'Længste træning',
    infoLongestNote:     'længste session pr. uge, minutter',
    infoPanelWork:       'Ugentligt arbejde (kJ)',
    infoPanelZones:      'Tid i zoner',
    infoPanelPeakPower:  'Peak Power (W)',
    infoPanelPeakHr:     'Peak Puls (bpm)',
    infoReadingCount:    '{n} af {total} paneler har en måling',
    ...
    infoCompareOpen:     '⇆ Sammenlign sessioner',
    infoCompareTitle:    'Sammenlign sessioner',
    infoCompareResultTitle: 'Sessionssammenligning',
    infoCompareClose:    'Luk',
    infoCompareBack:     '‹ Skift valg',
    infoCompareGo:       'Sammenlign ({n})',
    infoCompareHint:     'vælg 2 eller flere — sammenligninger af samme slags viser progressionen',
    infoCompareNote:     'Hvordan det føltes — ved siden af hvad der blev gjort.',
    infoAllSports:       'Alle sportsgrene',
    infoAllTypes:        'Alle typer',
    infoColDate:         'Dato',
    infoColSession:      'Session',
    infoColSport:        'Sport',
    infoColType:         'Type',
    infoDuration:        'Varighed',
    infoDistance:        'Distance',
    infoAvgPower:        'Gns. watt',
    infoAvgHr:           'Gns. puls',
    infoRange_r4:        'Seneste 4 uger',
    infoRange_r12:       'Seneste 12 uger',
    infoRange_all:       'Al historik',
    infoAddToGraph:      'Føj til sammenligningsgraf',
    infoEnlarge:         'Forstør',
    infoGraphTitle:      'Sammenligningsgraf',
    infoGraphClear:      'Ryd',
    infoGraphRemove:     'Fjern fra sammenligningsgraf',
    infoGraphNote:       'hver linje er skaleret til sit eget interval — sammenlign former over tid, ikke værdier',
    // Main coach page buttons
    ...
    feedbackBodyShort:  'Krop',
    feedbackMindShort:  'Hoved',
