...
export default function LocaleError({
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center gap-4 bg-background px-6 text-center">
      <p className="font-body text-sm uppercase tracking-[0.24em] text-destructive">
        {t('eyebrow')}
      </p>
      ...
      <button
        type="button"
        onClick={reset}
        className="mt-2 border border-signal px-4 py-2.5 font-body text-sm uppercase tracking-[0.16em] text-signal transition-colors hover:bg-signal hover:text-signal-foreground"
      >
        {t('retry')}
      </button>
    </main>
