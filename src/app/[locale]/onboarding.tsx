 ...
 * bordered option tiles, and the climax hand-off screen. The history-upload
 * step it assumed does not exist here — upload is its own feature reachable
 * from the Training Plan — so this port carries the *look*, not that step: no
 * Back control either, since the real flow persists step by step server-side
 * and has no "unsubmit".
 */
