...
- **Pairing.** A throwaway `/prototype` should accompany this PRD to validate the interaction feel (drawer, references, three-speaker attribution, composer) before V1 commits.
